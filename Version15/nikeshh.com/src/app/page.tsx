...
const Home = async () => {
  ...
  return (
    <>
      ...
      <Navigation />
      <StarGrid />
      <section id="banner" className="container pt-26 md:pt-24 xl:pt-[5rem] relative flex items-center md:justify-center flex-wrap md:flex-nowrap gap-5">
        <div className="flex justify-center relative flex-col flex-wrap gap-2 md:gap-4 lg:flex-2">
          ...
          <div className="bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text relative mt-2 mb-2">
            ...
            <span className='py-2 text-white'><Link href="/business-solutions" className='underline hover:text-blue-700'>Business Solutions</Link> ◦ <Link href="/business-solutions" className='underline hover:text-blue-700'>Applications</Link> ◦ <Link href="/business-solutions" className='underline hover:text-blue-700'>Software Products</Link> ◦ <Link href="/business-solutions" className='underline hover:text-blue-700'>Automations</Link> ◦ <Link href="/business-solutions" className='underline hover:text-blue-700'>Systems</Link></span>
          </div>
          <p>
