...
const Contact = () => {
    ...
    return (
        <section id="contact" className="flex flex-col items-center pt-12 md:pt-44">
            <div className="container relative flex gap-4 flex-wrap md:flex-nowrap items-center justify-center">
