const SkillCard = ({ data, name, category, subcategory }) => {
    return (
        <div class="row g-0 rounded overflow-hidden flex-md-row h-md-250 position-relative">
            <div class="col p-4 d-flex flex-column position-static">
                ...
                <a href={"skill-single.html?category=" + category + "&subcategory=" + subcategory + "&learn-more=" + data["learn-more"]} class="stretched-link blog-card-text">Learn More</a>
            </div>
