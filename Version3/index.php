...
<html lang="en">
    <head>
        ...
        <title>Nikeshh V Portfolio</title>
                    ...
                    <div class="row portfolio-grid justify-content-center">
                        <div class="col-lg-4 col-md-6 all latest">
                            <div class="portfolio_box">
                                ...
                                <div class="short_info">
                                    <h4><a href="portfolio-details.php">minimal design</a></h4>
                        ...
                        <div class="col-lg-4 col-md-6 all popular">
                            <div class="portfolio_box">
                                ...
                                <div class="short_info">
                                    <h4><a href="portfolio-details.php">Paint wall</a></h4>
                                    <p>Animated, portfolio</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 all latest">
                            <div class="portfolio_box">
                                ...
                                <div class="short_info">
                                    <h4><a href="portfolio-details.php">female light</a></h4>
                                    <p>Animated, portfolio</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 all popular">
                            <div class="portfolio_box">
                                ...
                                <div class="short_info">
                                    <h4><a href="portfolio-details.php">fourth air</a></h4>
                                    <p>Animated, portfolio</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 all following">
                            <div class="portfolio_box">
                                ...
                                <div class="short_info">
                                    <h4><a href="portfolio-details.php">together sign</a></h4>
                                    <p>Animated, portfolio</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 all upcoming">
                            <div class="portfolio_box">
                                ...
                                <div class="short_info">
                                    <h4><a href="portfolio-details.php">multiply fowl</a></h4>
                                    <p>Animated, portfolio</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 all upcoming following">
                            <div class="portfolio_box">
                                ...
                                <div class="short_info">
                                    <h4><a href="portfolio-details.php">green heaven</a></h4>
                                    <p>Animated, portfolio</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 all upcoming">
                            <div class="portfolio_box">
                                ...
                                <div class="short_info">
                                    <h4><a href="portfolio-details.php">season face</a></h4>
                                    <p>Animated, portfolio</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row footer_bottom justify-content-center">
                    <p class="col-lg-8 col-sm-12 footer-text">
                        ...
                        All rights reserved | With <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://nikeshh.com" target="_blank">Nikeshh V</a>
                    </p>
                </div>
            </div>
        </footer>
