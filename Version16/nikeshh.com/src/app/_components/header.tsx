...
const Header = () => {
  ...
  return (
    <>
      <header id="header" className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
        <nav
          ...
          >
            <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7">
              {userId ? (
                ...
                <Link
                  className="flex items-center gap-x-2 font-medium text-gray-500 hover:text-blue-600 md:border-s md:border-gray-300 md:my-6 md:ps-6 dark:border-neutral-700 dark:text-neutral-400 dark:hover:text-blue-500"
                  href="/sign-in"
                >
                  <svg
