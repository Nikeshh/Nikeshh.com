import { BlogCategory, BlogComment, BlogPost } from "@prisma/client";
...
const developmentShowcaseProjects = [
  {
    ...
    content: `
      <div className="container mx-auto p-6 shadow-lg">
        <div className="flex justify-center">
          <a href="https://www.nikeshhcodes.com/blog/30001" target="_blank">Learn how to implement MongoDB CRUD operation using Nextjs in this blog</a>
...
export type BlogPostWithCategoriesAndComments = BlogPost & { categories: BlogCategory[]; comments: BlogComment[]; };

export const getBlogs = cache(async (): Promise<BlogPostWithCategoriesAndComments[]> => {
  try {
