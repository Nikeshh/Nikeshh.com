        ...
        <>
            <div className="card" style={{ width: '100%' }}>
                ...
                <div className="card-body">
                    <div className="metadata" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
                        <div className="post-date">
                            <p style={{ backgroundColor: 'rgb(236, 204, 236)', color: 'purple', paddingTop: '5px', paddingBottom: '5px', paddingLeft: '10px', paddingRight: '10px', borderRadius: '30px' }}>
